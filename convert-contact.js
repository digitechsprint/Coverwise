...
const htmlContent = fs.readFileSync(path.join(__dirname, '../Cover Wise/coverwiseimf.com/contact/index.html'), 'utf-8');
...
fs.mkdirSync(path.join(__dirname, 'src/app/contact'), { recursive: true });
fs.writeFileSync(path.join(__dirname, 'src/app/contact/page.js'), pageJs);
console.log("Contact page conversion complete");
