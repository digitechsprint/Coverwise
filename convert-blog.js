...
const htmlContent = fs.readFileSync(path.join(__dirname, '../Cover Wise/coverwiseimf.com/blog/index.html'), 'utf-8');
...
fs.mkdirSync(path.join(__dirname, 'src/app/blog'), { recursive: true });
fs.writeFileSync(path.join(__dirname, 'src/app/blog/page.js'), pageJs);
console.log("Blog page conversion complete");
