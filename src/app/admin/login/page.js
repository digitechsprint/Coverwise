  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        // Force a hard navigation to /admin to ensure layout updates and middleware runs properly
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <Link href="/">
            <div className="text-3xl font-extrabold text-blue-600 flex items-center justify-center space-x-2">
              <span className="bg-blue-600 text-white p-2 rounded-lg">CW</span>
              <span>CoverWise</span>
            </div>
          </Link>
        </div>
