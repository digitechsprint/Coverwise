...
const htmlContent = fs.readFileSync(path.join(__dirname, '../Cover Wise/coverwiseimf.com/our-portfolio/index.html'), 'utf-8');
...
fs.mkdirSync(path.join(__dirname, 'src/app/our-portfolio'), { recursive: true });
fs.writeFileSync(path.join(__dirname, 'src/app/our-portfolio/page.js'), pageJs);
console.log("Portfolio page conversion complete");
